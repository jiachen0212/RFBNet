...
parser.add_argument('--ngpu', default=1,
                    type=int, help='gpus')
parser.add_argument('--lr', '--learning-rate', default=4e-3,
...
def train():
    ...
    for iteration in range(start_iter, max_iter):   # 共需迭代的次数，是否finetune间有差异，同时也对应到了epoch次数
        ...
        # print demo：Epoch:227 || epochiter: 268/517|| Totel iter 117110 || L: 0.5620 C: 1.1416||Batch time: 0.9760 sec. ||LR: 0.00004000
        if iteration % 10 == 0:
